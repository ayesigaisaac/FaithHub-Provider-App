import{r as l,j as f}from"./vendor-Ren8gyrv.js";const u=`
:root{
  --bg: #eef4f1;
  --bg-2: #f7faf8;
      ...
      <aside class="fh-sidebar">
        ...
        <div class="fh-sidebar-scroll">
          <div class="fh-scroll-inner">
            ...
            <section class="fh-nav-section" data-section-id="revelight">
              <button class="fh-accordion-header" type="button" aria-expanded="false" data-section-trigger="revelight">
                <span class="fh-accordion-title">
                  ...
                  <span class="fh-nav-title-text">REVELIGHT</span>
                </span>
                <span class="fh-accordion-chevron"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" ><path d="m8 10 4 4 4-4"/></svg></span>
              </button>
              <div class="fh-nav-panel">
                
                <button class="fh-nav-item" type="button" data-item-id="revelight-dashboard" data-parent-id="revelight">
                  <span class="fh-nav-item-left">
                    ...
                    <span class="fh-nav-item-label">Revelight Dashboard</span>
                  </span>
                  
                </button>
            
                <button class="fh-nav-item" type="button" data-item-id="revelight-builder" data-parent-id="revelight">
                  <span class="fh-nav-item-left">
                    ...
                    <span class="fh-nav-item-label">Revelight Builder</span>
                  </span>
                  
                </button>
            
                <button class="fh-nav-item" type="button" data-item-id="revelight-marketplace" data-parent-id="revelight">
                  <span class="fh-nav-item-left">
                    ...
                    <span class="fh-nav-item-label">Revelight Marketplace</span>
                  </span>
                  
                </button>
            
                <button class="fh-nav-item" type="button" data-item-id="revelight-manager" data-parent-id="revelight">
                  <span class="fh-nav-item-left">
                    ...
                    <span class="fh-nav-item-label">Revelight Manager</span>
                  </span>
        ...
        <div class="fh-sidebar-footer">
          <h4>Quick Create</h4>
          <p>Launch a live session, teaching, Revelight campaign, or giving moment without leaving the shell.</p>
        ...
        <header class="fh-topbar">
          <div class="fh-topbar-primary">
            ...
            <div class="fh-search-wrap">
              ...
              <span>Search live sessions, teachings, contacts, Revelight campaigns, funds, and settings</span>
            </div>
          ...
          <div class="fh-topbar-secondary">
            <div class="fh-page-title">
              ...
              <p>One elegant desktop shell for live ministry, teachings, outreach, Revelight promotion, charity & giving, community care, team governance, moderation, audit, and QA.</p>
            </div>
            <div class="fh-command-actions">
              ...
              <button class="fh-secondary-btn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" ><path d="M4.5 12.5V9l10-4v11l-10-3.5Z"/><path d="M14.5 8.5h2a3 3 0 0 1 0 6h-2"/><path d="m7.5 14.5 1.4 4"/></svg><span>Launch Revelight</span></button>
          ...
          <main class="fh-main">
            <section class="fh-hero-card">
              ...
              <div class="fh-hero-badges">
                ...
                <span class="fh-chip chip-soft"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" ><path d="M4.5 12.5V9l10-4v11l-10-3.5Z"/><path d="M14.5 8.5h2a3 3 0 0 1 0 6h-2"/><path d="m7.5 14.5 1.4 4"/></svg><span>Revelight Linked or Standalone</span></span>
                ...
                <div class="fh-feature-layout">
                  ...
                  <div class="fh-soft-panel">
                    ...
                    <ul class="fh-feature-list">
                      ...
                      <li>Revelight as linked or standalone promotion</li>
            ...
            <article class="fh-rail-card">
              ...
              <div class="fh-health-panel">
                ...
                <div class="fh-health-copy">
                  ...
                  <p>Moderation response times are inside target, live dependencies are green, and the FaithHub Provider workspace is ready for scale.</p>
                </div>
              </div>
            </article>
