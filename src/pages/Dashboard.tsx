...
function DashboardHeader() {
  return (
    <header className="overflow-hidden rounded-[28px] border border-[var(--fh-line)] bg-[linear-gradient(135deg,var(--fh-surface)_0%,color-mix(in_srgb,var(--fh-brand-soft)_45%,white)_100%)] p-6 shadow-[0_12px_28px_rgba(15,23,42,0.05)] sm:p-7">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <div className="inline-flex items-center rounded-full border border-[var(--fh-line)] bg-white/80 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-[var(--fh-slate)]">
            Provider overview
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            type="button"
            className="inline-flex items-center gap-2 rounded-xl border border-[var(--fh-line)] bg-white/80 px-4 py-2.5 text-sm font-medium text-[var(--fh-slate)] shadow-sm transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--fh-brand)] focus-visible:ring-offset-2"
          >
