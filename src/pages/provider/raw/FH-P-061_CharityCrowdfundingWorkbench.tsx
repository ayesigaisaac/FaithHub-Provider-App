...
function MetricCard({
  ...
  const accent = tone === "green" ? EV_GREEN : tone === "orange" ? EV_ORANGE : EV_NAVY;
  return (
    <div className="rounded-3xl bg-slate-50 dark:bg-slate-800/50 p-3 ring-1 ring-slate-200 dark:ring-slate-800">
      ...
      <div className="mt-1 text-2xl font-extrabold text-slate-900 dark:text-slate-50">{value}</div>
      {hint ? <div className="mt-1 text-xs text-slate-500 dark:text-slate-400">{hint}</div> : null}
      <div className="mt-3 h-1.5 rounded-full" style={{ background: `${accent}22` }}>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-3xl bg-slate-50 dark:bg-slate-800/40 p-4 ring-1 ring-slate-200 dark:ring-slate-800">
          ...
          <div className="mt-3 space-y-3 text-sm text-slate-600 dark:text-slate-300">
            ...
            <div className="rounded-2xl bg-white dark:bg-slate-900 p-3 ring-1 ring-slate-200 dark:ring-slate-800">After creation, route the campaign into Live Sessionz, Audience Notifications, and Beacon from the workbench.</div>
          </div>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <div className="space-y-4">
            <div className="rounded-3xl bg-slate-50 dark:bg-slate-800/40 p-4 ring-1 ring-slate-200 dark:ring-slate-800">
              ...
              <div className="mt-3 space-y-3 text-sm text-slate-600 dark:text-slate-300">
                ...
                <div className="rounded-2xl bg-white dark:bg-slate-900 p-3 ring-1 ring-slate-200 dark:ring-slate-800">After publish, route the same campaign into Live Sessionz, replay follow-up, notifications, and Beacon while preserving governance context.</div>
              </div>
            </div>
            <div className="flex flex-wrap gap-2">
