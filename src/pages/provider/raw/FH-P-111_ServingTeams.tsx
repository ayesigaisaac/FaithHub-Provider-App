    ...
    assignments: [
      {
        ...
        surface: "Live Sessionz prayer intake",
        when: "Tue · 8:00 PM",
        state: "Training due",
      },
      {
  ...
  return (
    <div
      className={cx(
        ...
        mode === "desktop" ? "w-full" : "mx-auto w-[320px]",
      )}
    >
        ...
        <div className="mt-4 grid gap-4 xl:grid-cols-[1.2fr_0.95fr_0.78fr] xl:items-start">
          ...
          <div className="space-y-4">
            ...
            <SectionCard
              ...
              right={selectedTeam?.liveLinked ? <TonePill tone="good">Connected to Live Sessionz</TonePill> : <TonePill tone="neutral">Campus-first coverage</TonePill>}
            >
              <div className="space-y-3">
