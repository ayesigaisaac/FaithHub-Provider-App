...
/**
 * FaithHub Provider - Revelight Marketplace
 * --------------------------------------
...
const INVENTORY_SEED: InventoryPlacement[] = [
  ...
  },
  {
    ...
    ctaRule: "CTA can drive replay, clip, Revelight follow-up, or giving tie-in.",
        ...
        <div className="flex items-start justify-between gap-3 border-b border-faith-line dark:border-slate-800 px-5 py-4">
          <div className="min-w-0">
            ...
            <div className="mt-1 text-[12px] text-faith-slate">
              Review performance examples, policy notes, and transfer to Revelight Builder.
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <SectionCard title="Actions">
                <div className="grid gap-2">
                  ...
                  <AccentButton tone="orange" onClick={() => safeNav(ROUTES.revelightBuilder)}>
                    <Zap className="h-4 w-4" /> Transfer to Revelight Builder
                  </AccentButton>
                  <SoftButton
                    onClick={() => {
...
export default function RevelightMarketplacePage() {
  ...
  const [mediaPlanName, setMediaPlanName] = useState("Revelight Marketplace Plan · Weekend Launch");
        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-col justify-between gap-4 xl:flex-row xl:items-start">
            ...
            <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 xl:flex xl:w-auto xl:flex-wrap xl:justify-end">
              <AccentButton className="h-10 w-full justify-center px-4 xl:w-auto" tone="green" onClick={() => safeNav(ROUTES.revelightBuilder)}>
              ...
              <SoftButton className="h-10 w-full justify-center px-4 xl:w-auto" onClick={() => safeNav(ROUTES.revelightManager)}>
          ...
          <div className="grid gap-4 2xl:grid-cols-[450px_minmax(0,1fr)_326px]">
            ...
            <div className="space-y-4">
              <SectionCard
                ...
                subtitle="Preview selected inventory like a premium merchandising experience before handing it into Revelight Builder."
                right={
              ...
              <div className="grid gap-4 2xl:grid-cols-[minmax(0,1fr)_360px]">
                <SectionCard
                  ...
                  subtitle="Combine placements, compare expected outcomes, save plan combinations, and hand them into Revelight Builder."
                >
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <AccentButton tone="green" onClick={() => safeNav(ROUTES.revelightBuilder)}>
                        <Zap className="h-4 w-4" /> Send to Revelight Builder
                      </AccentButton>
                    </div>
                  </div>
                </SectionCard>
          ...
          <div className="grid gap-3 lg:grid-cols-4">
            {[
              ...
              },
              {
                ...
                body: "Moves selected placement plans directly into Revelight Builder without rebuilding the campaign.",
              },
            ].map((tile) => (
              <div
                key={tile.title}
