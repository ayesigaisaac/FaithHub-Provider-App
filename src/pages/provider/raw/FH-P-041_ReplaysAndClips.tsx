 ...
 * -----------------------------------
 * Premium replay library and clip engine for FaithHub Provider workspace.
 *
 * Design goals
...
function Modal({
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-end justify-center sm:items-center p-0 sm:p-4">
      ...
      <div className="relative flex w-full max-w-6xl flex-col bg-[var(--fh-surface-bg)] dark:bg-slate-900 shadow-medium h-[94dvh] sm:h-auto sm:max-h-[92dvh] rounded-t-3xl sm:rounded-3xl overflow-hidden ring-1 ring-slate-200 dark:ring-slate-800 transition">
...
function SelectField({
  ...
  return (
    <select
      ...
      className="h-11 rounded-2xl border border-faith-line/70 dark:border-slate-800 bg-[var(--fh-surface-bg)] dark:bg-slate-900 px-3 text-sm text-faith-ink dark:text-slate-100 shadow-soft transition focus:outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-slate-700"
    >
      {options.map((option) => (
...
function PreviewCanvas({
  ...
  return (
    <div className="rounded-[28px] border border-faith-line/70 dark:border-slate-800 bg-slate-100 dark:bg-slate-950 p-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl border border-faith-line/70 dark:border-slate-800 bg-[var(--fh-surface-bg)] dark:bg-slate-950 px-3 py-2 text-[11px] font-bold text-faith-ink dark:text-slate-100 hover:bg-[var(--fh-surface)] dark:hover:bg-slate-800"
            >
        ...
        <div className="w-full px-4 md:px-6 lg:px-8 py-4">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 xl:flex xl:w-auto xl:flex-wrap xl:justify-end">
              ...
              <Btn tone="neutral" className="h-10 px-4" onClick={() => archiveReplay()} left={<Archive className="h-4 w-4" />} disabled={workingAction === "archiveReplay"}>
                          ...
                          <div key={moment.id} className="rounded-2xl bg-[var(--fh-surface)] dark:bg-slate-800/50 p-3 ring-1 ring-slate-200 dark:ring-slate-800">
                            <div className="flex items-start justify-between gap-3">
                              <div>
                                ...
                                <div className="mt-1 text-[11px] text-faith-slate">{secondsToClock(moment.startSec)} ? {secondsToClock(moment.endSec)} Â· {moment.reason}</div>
                              </div>
                      ...
                      {batchClips.map((clip) => (
                        <div key={clip.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 rounded-2xl bg-[var(--fh-surface-bg)] dark:bg-slate-900 px-3 py-3 ring-1 ring-slate-200 dark:ring-slate-800">
                          <div>
                            ...
                            <div className="mt-1 text-[11px] text-faith-slate">{secondsToClock(clip.startSec)} ? {secondsToClock(clip.endSec)} Â· {clip.intent}</div>
                          </div>
                          <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="rounded-3xl bg-[var(--fh-surface)] dark:bg-slate-800/30 p-4 ring-1 ring-slate-200 dark:ring-slate-800">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      <div>
                        ...
                        <div className="mt-1 text-sm font-bold text-faith-ink dark:text-slate-100">{secondsToClock(clipStart)} ? {secondsToClock(clipEnd)} Â· {secondsToClock(clipDuration)} clip length</div>
                      </div>
                      <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
                  {[
                    ...
                    return (
                      <button key={card.title} type="button" onClick={card.action} className="rounded-3xl border border-faith-line/70 dark:border-slate-800 bg-[var(--fh-surface)] dark:bg-slate-800/30 p-4 text-left hover:border-slate-300 dark:hover:border-slate-700 transition">
              ...
              <div className="mt-4 space-y-3">
                    ...
                    {APPROVALS.map((approval) => (
                      <div key={approval.label} className="flex items-center justify-between gap-2 rounded-2xl bg-[var(--fh-surface-bg)] dark:bg-slate-900 px-3 py-3 ring-1 ring-slate-200 dark:ring-slate-800">
                        <div>
                          ...
                          <div className="mt-1 text-[11px] text-faith-slate">Owner Â· {approval.owner}</div>
                        </div>
                ...
                <div className="rounded-3xl bg-[var(--fh-surface)] dark:bg-slate-800/30 p-4 ring-1 ring-slate-200 dark:ring-slate-800">
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    <input value={commentDraft} onChange={(e) => setCommentDraft(e.target.value)} placeholder="Add a collaboration note" className="flex-1 rounded-2xl border border-faith-line/70 dark:border-slate-800 bg-[var(--fh-surface-bg)] dark:bg-slate-900 px-3 py-2.5 text-sm text-faith-ink dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-slate-700" />
                      ...
                      <div key={task.id} className="rounded-2xl bg-[var(--fh-surface-bg)] dark:bg-slate-900 px-3 py-3 ring-1 ring-slate-200 dark:ring-slate-800">
                        <div className="flex items-start justify-between gap-2">
                          <div>
                            ...
                            <div className="mt-1 text-[11px] text-faith-slate">{task.owner} Â· due {task.due}</div>
                          </div>
