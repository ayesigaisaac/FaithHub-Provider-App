...
/**
 * FaithHub Provider - Revelight Dashboard
 * ------------------------------------
 ...
 * - Reflect the Revelight model clearly: linked and standalone campaigns, spend pacing, creative quality,
...
const CAMPAIGNS_SEED: RevelightCampaign[] = [
  {
    id: "bc_replay_grace",
    ...
    placementLeads: ["Feed", "Replay rail", "Revelight cards"],
...
const QUICK_CREATE_PRESETS: QuickCreatePreset[] = [
  {
    ...
    subtitle: "Turn a replay into a premium Revelight campaign in one step.",
    mode: "Linked",
    accent: "green",
    route: ROUTES.replaysAndClips,
  },
...
function BrowserPreview({ campaign }: { campaign: RevelightCampaign }) {
  const primaryCTA =
  ...
  return (
    <div className="overflow-hidden rounded-[28px] border border-faith-line/70 dark:border-slate-800 bg-slate-950 shadow-soft transition-colors">
      <div className="relative aspect-[16/9] overflow-hidden">
        ...
        <div className="absolute left-4 top-4 flex flex-wrap gap-2">
          <span className="rounded-full bg-black/45 px-3 py-1 text-[10px] font-black uppercase tracking-[0.14em] text-white backdrop-blur">Revelight</span>
        ...
        <div className="absolute inset-x-0 bottom-0 p-4 text-white">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <button
              ...
              onClick={() => safeNav("/faithhub/provider/revelight-dashboard")}>
              Learn more
            </button>
          </div>
        </div>
...
function PhonePreview({ campaign }: { campaign: RevelightCampaign }) {
  const primaryLabel =
    campaign.sourceType === "Crowdfund" || campaign.sourceType === "Fund"
      ? "Give"
      : campaign.sourceType === "Event"
      ...
      <div className="overflow-hidden rounded-[28px] bg-[var(--fh-surface-bg)] dark:bg-slate-950 transition-colors">
        <div className="min-h-[560px] overflow-hidden">
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 px-3 py-3">
            <div className="text-[13px] font-extrabold text-faith-ink dark:text-slate-100 whitespace-normal break-words [overflow-wrap:anywhere]">Revelight feed preview</div>
          ...
          <div className="p-3">
            <div className="overflow-hidden rounded-3xl border border-slate-100 dark:border-slate-800 bg-[var(--fh-surface)] dark:bg-slate-900 shadow-soft">
              ...
              <div className="space-y-3 p-3">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center justify-center rounded-2xl border border-faith-line/70 dark:border-slate-700 bg-[var(--fh-surface-bg)] dark:bg-slate-900 px-3 py-2.5 text-[12px] font-black text-faith-ink dark:text-slate-100"
            ...
            <div className="mt-3 rounded-3xl border border-slate-100 dark:border-slate-800 bg-[var(--fh-surface)] dark:bg-slate-900 p-3 shadow-soft">
              ...
              <div className="mt-3 text-[12px] text-faith-slate leading-relaxed">
                Preview shows how the selected Revelight creative sits inside premium Feed surfaces.
              </div>
            </div>
          </div>
        </div>
...
export default function RevelightDashboardPage() {
  const [campaigns] = useState<RevelightCampaign[]>(CAMPAIGNS_SEED);
  ...
  return (
    <div className="min-h-full w-full flex flex-col bg-[var(--fh-page-bg)] dark:bg-slate-950 text-faith-ink dark:text-slate-50 transition-colors overflow-x-hidden">
        ...
        <div className="w-full px-4 sm:px-5 md:px-6 lg:px-8 py-4">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 xl:flex xl:w-auto xl:flex-wrap xl:justify-end">
              <Btn className="h-10 w-full justify-center px-4 xl:w-auto" tone="neutral" onClick={() => safeNav(ROUTES.revelightMarketplace)} left={<Layers className="h-4 w-4" />}>
                Revelight Marketplace
              </Btn>
              <Btn className="h-10 w-full justify-center px-4 xl:w-auto" tone="neutral" onClick={() => safeNav(ROUTES.revelightManager)} left={<BarChart3 className="h-4 w-4" />}>
              ...
              <Btn className="h-10 w-full justify-center px-4 xl:w-auto" tone="primary" onClick={() => safeNav(ROUTES.revelightBuilder)} left={<Plus className="h-4 w-4" />}>
                New Ad
              </Btn>
            </div>
          </div>
          ...
          <div className="min-w-0 lg:col-span-8 space-y-4">
            <div className="rounded-3xl bg-[var(--fh-surface-bg)] dark:bg-slate-900 p-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-soft transition">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 2xl:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
                ...
                <div className="rounded-3xl bg-[var(--fh-surface)] dark:bg-slate-800/50 p-4 ring-1 ring-slate-200 dark:ring-slate-800">
                  ...
                  <div className="mt-1 text-xs text-faith-slate">Revelight outcomes tied back to live attendance, replay views, donations, event registrations, and follows.</div>
            ...
            <div className="rounded-3xl bg-[var(--fh-surface-bg)] dark:bg-slate-900 p-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-soft transition">
              ...
              <div className="mt-4 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                <div className="flex flex-1 items-center gap-2 rounded-2xl border border-faith-line/70 dark:border-slate-800 bg-[var(--fh-surface)] dark:bg-slate-950 px-3 py-2 transition-colors">
              ...
              <div className="mt-4 space-y-3">
                ...
                {!filtered.length ? (
                  <div className="rounded-3xl border border-dashed border-slate-300 dark:border-slate-700 bg-[var(--fh-surface)] dark:bg-slate-900 px-4 py-8 text-center">
                    ...
                    <div className="mt-1 text-xs text-faith-slate">Clear the filters or launch a new Revelight campaign.</div>
                  </div>
                ) : null}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
              ...
              <div className="rounded-3xl bg-[var(--fh-surface-bg)] dark:bg-slate-900 p-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-soft transition">
                <SectionTitle
                  ...
                  subtitle="See where Revelight results are coming from by segment, region, surface, language, and placement type."
                />
            ...
            <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
              ...
              <div className="rounded-3xl bg-[var(--fh-surface-bg)] dark:bg-slate-900 p-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-soft transition">
                ...
                <div className="mt-4 rounded-3xl bg-[var(--fh-surface)] dark:bg-slate-800/50 p-4 ring-1 ring-slate-200 dark:ring-slate-800">
                  ...
                  <div className="mt-1 text-xs text-faith-slate">Fastest way to create a variant from the currently selected Revelight campaign.</div>
          ...
          <div className="min-w-0 lg:col-span-4 space-y-4">
            <div className="rounded-3xl bg-[var(--fh-surface-bg)] dark:bg-slate-900 p-4 ring-1 ring-slate-200 dark:ring-slate-800 shadow-soft transition lg:sticky lg:top-24">
              <SectionTitle
                ...
                subtitle="Desktop and mobile Revelight surfaces update from the selected campaign."
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-1">
                <div className="rounded-3xl bg-[var(--fh-surface)] dark:bg-slate-800/50 p-4 ring-1 ring-slate-200 dark:ring-slate-800">
                  ...
                  <div className="mt-1 text-xs text-faith-slate">Linked and standalone campaign mix across the active Revelight portfolio.</div>
                  <div className="mt-4 grid grid-cols-2 gap-3">
      ...
      <Modal
        ...
        subtitle="Preview how the selected Revelight campaign appears across premium promotion surfaces."
      >
          ...
          <div className="space-y-4">
            <div className="rounded-3xl bg-[var(--fh-surface)] dark:bg-slate-800/50 p-4 ring-1 ring-slate-200 dark:ring-slate-800">
              ...
              <div className="mt-3 space-y-2 text-xs text-faith-slate leading-relaxed">
                <div>• Linked and standalone Revelight campaigns use the same premium preview system so teams can compare quality consistently.</div>
