...
function Drawer({
  ...
  return (
    <div className="fixed inset-0 z-[110]">
      ...
      <div className="absolute right-0 top-0 h-full w-full bg-[var(--fh-surface-bg)] dark:bg-slate-900 shadow-medium ring-1 ring-slate-200 dark:ring-slate-800 transition-colors">
...
function BrowserPreview({
  ...
  return (
    <div className="overflow-hidden rounded-[28px] border border-faith-line/70 dark:border-slate-800 bg-[var(--fh-surface-bg)] dark:bg-slate-950 shadow-soft transition">
...
function PhonePreview({
  ...
  return (
    <div className="mx-auto w-full max-w-[320px] md:max-w-[360px]">
      <div className="overflow-hidden rounded-[36px] bg-[#08132c] p-3 shadow-medium">
        <div className="rounded-[28px] bg-[var(--fh-surface-bg)] dark:bg-slate-950 overflow-hidden transition-colors">
          ...
          <div className="p-4">
            ...
            <div className="mt-3 space-y-2 text-[11px]">
              ...
              <div className="rounded-2xl border border-faith-line/70 dark:border-slate-800 px-3 py-2 text-slate-700 dark:text-slate-300">Notes attached Ã‚Â· {notesAttached}</div>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-12">
                <div className="xl:col-span-5">
                  ...
                  <div className="mt-3 rounded-3xl bg-[var(--fh-surface)] dark:bg-slate-800/50 p-4 ring-1 ring-slate-200 dark:ring-slate-800 transition">
                    ...
                    <div className="mt-3 rounded-2xl border border-faith-line/70 dark:border-slate-700 bg-[var(--fh-surface-bg)] dark:bg-slate-900 px-3 py-2 text-xs text-faith-slate break-all">
                      {session.replayUrl}
                    </div>
                  </div>
                </div>
